...
class Blockchain:
    ...
    def to_json(self):
        """
        serialize the blockchain in to list of blocks
        """
        # serialized_chain = []
    ...
    def from_json(chain_json):
        """
        Desserialize a list of serealized blocks in to a blockchain instance.
    ...
    def is_valid_chain(chain):
        ...
        if chain[0] != Block.genesis():
            raise Exception('The genesiss block must be valid')
